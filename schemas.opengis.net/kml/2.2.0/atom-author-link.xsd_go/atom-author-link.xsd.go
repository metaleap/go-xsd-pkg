...
func (me *XsdGoPkgHasElem_Uri) Walk() {
	if fn := WalkHandlers.XsdGoPkgHasElem_Uri; fn != nil {
		fn(me)
	}
}
...
func (me *XsdGoPkgHasElems_Uri) Walk() {
	if fn := WalkHandlers.XsdGoPkgHasElems_Uri; fn != nil {
		fn(me)
	}
}
...
func (me *XsdGoPkgHasElems_Email) Walk() {
	if fn := WalkHandlers.XsdGoPkgHasElems_Email; fn != nil {
		fn(me)
	}
}
...
func (me *XsdGoPkgHasElem_Email) Walk() {
	if fn := WalkHandlers.XsdGoPkgHasElem_Email; fn != nil {
		fn(me)
	}
}
...
func (me *TatomPersonConstruct) Walk() {
	if fn := WalkHandlers.TatomPersonConstruct; fn != nil {
		fn(me)
	}
...
func (me *XsdGoPkgHasElem_Author) Walk() {
	if fn := WalkHandlers.XsdGoPkgHasElem_Author; fn != nil {
		fn(me)
	}
	me.Author.Walk()
}
...
func (me *XsdGoPkgHasElems_Author) Walk() {
	if fn := WalkHandlers.XsdGoPkgHasElems_Author; fn != nil {
		fn(me)
	}
...
func (me *TxsdLink) Walk() {
	if fn := WalkHandlers.TxsdLink; fn != nil {
		fn(me)
	}
}
