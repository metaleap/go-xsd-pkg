...
func (me *XsdGoPkgHasGroup_LogbaseContent) Walk() (err error) {
	if fn := WalkHandlers.XsdGoPkgHasGroup_LogbaseContent; me != nil {
		if fn != nil {
			if err = fn(me, true); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
				return
			}
...
func (me *TlogbaseType) Walk() (err error) {
	if fn := WalkHandlers.TlogbaseType; me != nil {
		...
		if err = me.XsdGoPkgHasGroup_LogbaseContent.Walk(); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
			return
		}
		if fn != nil {
			if err = fn(me, false); xsdt.OnWalkError(&err, &WalkErrors, WalkContinueOnError, WalkOnError) {
...
type XsdGoPkgWalkHandlers struct {
	...
	XsdGoPkgHasGroup_LogbaseContent                  func(*XsdGoPkgHasGroup_LogbaseContent, bool) error
