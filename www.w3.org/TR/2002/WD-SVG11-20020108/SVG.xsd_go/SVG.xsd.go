...
//	If the WalkHandlers.TaType function is not nil (ie. was set by outside code), calls it with this TaType instance as the single argument. Then calls the Walk() method on 38/57 embed(s) and 0/0 field(s) belonging to this TaType instance.
func (me *TaType) Walk ()  { 
...
//	If the WalkHandlers.TgType function is not nil (ie. was set by outside code), calls it with this TgType instance as the single argument. Then calls the Walk() method on 38/48 embed(s) and 0/0 field(s) belonging to this TgType instance.
func (me *TgType) Walk ()  { 
...
func (me *XsdGoPkgHasElem_Desc) Walk ()  { 
	if fn := WalkHandlers.XsdGoPkgHasElem_Desc; fn != nil { fn(me) }
	me.Desc.Walk()
 }
