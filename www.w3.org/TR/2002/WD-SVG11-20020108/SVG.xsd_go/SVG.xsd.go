...
//	If the WalkHandlers.TmarkerType function is not nil (ie. was set by outside code), calls it with this TmarkerType instance as the single argument. Then calls the Walk() method on 32/53 embed(s) and 0/0 field(s) belonging to this TmarkerType instance.
...
//	If the WalkHandlers.TdefsType function is not nil (ie. was set by outside code), calls it with this TdefsType instance as the single argument. Then calls the Walk() method on 34/48 embed(s) and 0/0 field(s) belonging to this TdefsType instance.
...
//	If the WalkHandlers.TswitchType function is not nil (ie. was set by outside code), calls it with this TswitchType instance as the single argument. Then calls the Walk() method on 20/30 embed(s) and 0/0 field(s) belonging to this TswitchType instance.
...
//	If the WalkHandlers.TsymbolType function is not nil (ie. was set by outside code), calls it with this TsymbolType instance as the single argument. Then calls the Walk() method on 38/48 embed(s) and 0/0 field(s) belonging to this TsymbolType instance.
